...
if __name__ == '__main__':
    ...
    if on_laptop:
        ...
        expdir = '/n/scratchlfs/macklis_lab/fding/rvr/experiments' #'/n/home06/fding/rvr/experiments/'
    ...
    # STANDARD PREVIOUSLY: #fair_coeffs = ['0_0', '0_5', '1_0', '3_0', '5_0', '10_0', '15_0']
    ...
    sweepname = 'runagree_large_interact_042919_thresh'
    seed = args.seed
