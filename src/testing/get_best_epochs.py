...
#    runp_dir = 'runp1_2_sweep_dp/data--runp1_2--model_adim-10--model_class-WeightedDemParMultiWassGan--model_fair_coeff-{}--model_recon_coeff-{}'
    runp_dir = 'runp1_2_sweep_eo/data--runp1_2--model_adim-10--model_class-MultiEqOddsUnweightedWassGan--model_fair_coeff-{}--model_recon_coeff-{}'
    ...
    np.save('runp_1_2_sweep_eo_score_mat.npy', score_mat)
